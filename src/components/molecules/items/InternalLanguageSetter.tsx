...
const InternalLanguageSetter = (props: any) => {
  const [anchorEl, setAnchorEl] = useState(null);
  const theme = useTheme();
  const { t , i18n} = useTranslation('translation');
  const { t: innerT , i18n: internali18n} = useTranslation('externals');
        ...
        <div style={{
            ...
            <div 
              ...
              <div
                ...
                {internali18n.language.toUpperCase()}
              </div>
            </div>
          </IconButton>
        </div>
          ...
          >
            <InternalLanguages 
              ...
              onLanguageChange={async (lng: string)=>{
                if(i18n.languages.findIndex(p => p === lng) > -1){
